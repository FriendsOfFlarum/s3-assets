    ...
    return (
      <div className="ExtensionPage--settings">
        <div className="container">
          {s3SetByEnv ? (
            <h3 className="ExtensionPage-subHeader">{app.translator.trans('fof-s3-assets.admin.settings.configured_by_environment')}</h3>
          ) : (
            <div className="Form-group">
              <h3>{app.translator.trans('fof-s3-assets.admin.settings.aws-section')}</h3>
              ...
              <h3>{app.translator.trans('fof-s3-assets.admin.settings.s3-compatible-section')}</h3>
              <p className="helpText">{app.translator.trans('fof-s3-assets.admin.settings.s3-compatible-section-help')}</p>
              {this.buildSettingComponent({
